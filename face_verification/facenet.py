...
import numpy as np
from tensorflow.keras.layers import Dense, ZeroPadding2D, Activation
from tensorflow.keras.layers import Conv2D, MaxPooling2D, AveragePooling2D
from tensorflow.keras.layers import Input, Lambda, Flatten, concatenate
